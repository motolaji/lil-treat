...
```text
- This screen allows the user to edit their nickname once they click on
the field from their profile view. Make the profile icon + email + line 
underneath a separate component as this will be used for all other editable
fields. For now, just implement this screen for the user nickname
```
