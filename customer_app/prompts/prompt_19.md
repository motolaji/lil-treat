...
```text
This page is the profile detail page for users that signed in with Google. Wire that to the profile detail from
the sidebar for users logged in through google
```
